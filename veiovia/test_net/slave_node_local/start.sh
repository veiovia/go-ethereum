...
$GETH --datadir "$DATADIR" --unlock "$ACCOUNT" --password "$PASSWORD_FILE_PATH" --bootnodes "$BOOTNODE_ENODE" --networkid $NETWORKID --gasprice "$GASPRICE" --syncmode "full" --http --allow-insecure-unlock