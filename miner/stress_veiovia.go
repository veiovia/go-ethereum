...
// This file contains a miner stress test based on the Veiovia consensus engine.
package main
...
func main() {
	...
	// Create a Veiovia network based off of the Rinkeby config
...
// makeGenesis creates a custom Veiovia genesis block based on some pre-defined
...
func makeGenesis(faucets []*ecdsa.PrivateKey, sealers []*ecdsa.PrivateKey) *core.Genesis {
	...
	genesis.Config.Veiovia.Period = 1
